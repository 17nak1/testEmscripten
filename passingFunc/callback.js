...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'callback.wast';
  var wasmBinaryFile = 'callback.wasm';
  var asmjsCodeFile = 'callback.temp.asm.js';
...
var real__call = asm["_call"]; asm["_call"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__call.apply(null, arguments);
};
...
var _call = Module["_call"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_call"].apply(null, arguments) };
